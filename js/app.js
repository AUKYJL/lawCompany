 ...
 */
    ...
    (() => {
        ...
        if (telInput.length) modules_flsModules.inputmask = Inputmask("+7-(999)-999-99-99").mask(telInput);
        ...
        function initSliders() {
            if (document.querySelector(".swiper")) {
                new core(".our-specialists__slider", {
                    slidesPerView: "auto",
                    spaceBetween: 20,
                    speed: 800,
                    simulateTouch: true,
        ...
        function mapAdd() {
            ...
            tag.src = "https://maps.google.com/maps/api/js?sensor=false&amp;key=";
        ...
        function mapInit(n = 1) {
            ...
            var locations = [ [ new google.maps.LatLng(55.751794905093256, 37.5992941) ] ];
            var options = {
                zoom: 15,
                panControl: false,
        ...
        function createHeaderBG() {
            if (window.scrollY >= 100) header.classList.add("gray-header"); else header.classList.remove("gray-header");
        }
        window.addEventListener("scroll", (() => {
            createHeaderBG();
        }));
        document.addEventListener("click", (e => {
            if (e.target.closest(".menu__link")) menuLinkClick(e);
            if (e.target.closest("[data-popup='#order-popup']")) {
                const form = e.target.closest("form");
                const formInput = form ? form.querySelector("input") : null;
                if (formInput) {
                    const popup = document.querySelector("#order-popup");
                    const popupFormInput = popup.querySelector(`input[type='${formInput.getAttribute("type")}']`);
                    popupFormInput.value = formInput.value;
                    formInput.value = "";
                }
            }
        }));
